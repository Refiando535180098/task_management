                ...
                return (
                  <div className="max-h-[calc(100vh-260px)] overflow-y-auto custom-scrollbar print:max-h-none print:overflow-visible pb-10 print:pb-0">
                    <Card className="p-0 border-0 shadow-sm bg-white print:shadow-none print:border-none print:w-full overflow-hidden print-page">
                      <div className="p-3 md:p-5 print:p-0 print:pb-2 border-b-2 md:border-b-4 border-blue-600 bg-white print:border-b-2 print:border-black flex flex-col md:flex-row justify-between items-start md:items-center relative">
                        ...
                        <div className="flex gap-2 print:hidden absolute top-3 right-3 md:static">
                          <button type="button" onClick={handleDownloadPDF} className="flex items-center justify-center gap-1.5 px-3 py-1.5 md:px-4 md:py-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg font-bold text-[10px] md:text-xs transition-colors shadow-sm"><Printer className="w-3.5 h-3.5"/> Cetak PDF</button>
                        </div>
                      </div>
